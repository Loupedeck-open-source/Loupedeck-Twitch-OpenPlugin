namespace TwitchLib.Api.Core.RateLimiter
{
    ...
    public class TimeLimiter : IRateLimiter
    {
        ...
        public async Task Perform(Func<Task> perform, CancellationToken cancellationToken) 
        {
            ...
            using (await this._ac.WaitForReadiness(cancellationToken)) 
            {
                await perform();
            }
        }
        ...
        public static TimeLimiter GetFromMaxCountByInterval(Int32 maxCount, TimeSpan timeSpan)
        {
        ...
        public static TimeLimiter GetPersistentTimeLimiter(Int32 maxCount, TimeSpan timeSpan,
