namespace TwitchLib.Client.Models
{
    ...
    public class Subscriber : SubscriberBase
    {
        ...
        public Subscriber(List<KeyValuePair<String, String>> badges, String colorHex, String displayName, String emoteSet, String id, String login, String systemMessage,
