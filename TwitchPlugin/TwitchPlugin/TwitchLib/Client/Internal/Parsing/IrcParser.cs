namespace TwitchLib.Client.Internal.Parsing
{
    ...
    internal class IrcParser
    {
        ...
        public IrcMessage ParseIrcMessage(String raw)
        {
            ...
            lens[(Int32)state] = raw.Length - starts[(Int32)state];
            var cmd = raw.Substring(starts[(Int32)ParserState.STATE_COMMAND],
                lens[(Int32)ParserState.STATE_COMMAND]);
            ...
            var parameters = raw.Substring(starts[(Int32)ParserState.STATE_PARAM],
                lens[(Int32)ParserState.STATE_PARAM]);
            var message = raw.Substring(starts[(Int32)ParserState.STATE_TRAILING],
                lens[(Int32)ParserState.STATE_TRAILING]);
            var hostmask = raw.Substring(starts[(Int32)ParserState.STATE_PREFIX],
                lens[(Int32)ParserState.STATE_PREFIX]);
