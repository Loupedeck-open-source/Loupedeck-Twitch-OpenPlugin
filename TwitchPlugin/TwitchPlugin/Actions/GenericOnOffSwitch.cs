namespace Loupedeck.TwitchPlugin.Actions
{
    ...
    public abstract class GenericOnOffSwitch : PluginTwoStateDynamicCommand
    {
        ...
        {
            this.Name = name;
            this.OnStateImage = EmbeddedResources.ReadBinaryFile(TwitchPlugin.ImageResPrefix + onStateImage);
            this.OffStateImage = EmbeddedResources.ReadBinaryFile(TwitchPlugin.ImageResPrefix + offStateImage);
